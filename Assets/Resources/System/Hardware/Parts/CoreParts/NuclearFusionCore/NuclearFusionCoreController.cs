...
public class NuclearFusionCoreController : Part
{
    ...
    public override string Description()
    {
        ...
        showName = colorCode[int.Parse(GlobalManager.hardwarelist[GlobalManager.FindOption(GlobalManager.hardwarelist, "Level")][partName].ToString())] + "핵융합코어" + "</color>";
        string description =
            showName + "\n\n" +
